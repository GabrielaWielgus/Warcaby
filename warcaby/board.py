...
class Board:
    ...
    def get_valid_moves(self, piece):
        ...
        if piece.color == RED or piece.king:
            moves.update(self._traverse_left(row - 1, max(row - 3, -1), -1, piece.color, left))  # red up move
            moves.update(self._traverse_right(row - 1, max(row - 3, -1), -1, piece.color, right))  # red up move
