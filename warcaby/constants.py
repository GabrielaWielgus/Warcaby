...
try:
    ...
    BACKGROUND_GAME_OVER = pygame.transform.scale(pygame.image.load('warcaby/assets/background_game_over.png'),
                                                  (500, 500))
    BACKGROUND_RECT = BACKGROUND_RESET.get_rect()
    BACKGROUND_RECT_GO = BACKGROUND_GAME_OVER.get_rect()
except:
    raise OwnErrorMessage("There is not any file with added filename in direcotry")
